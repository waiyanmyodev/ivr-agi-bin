...
// intro
$agi->stream_file('ngo_ivr/mm/mm_intro', 24000);
...
for ($i = 1; $i <= 3; $i++) {
    ...
    if ($chosenLang === "") {
        ...
        for ($i = 1; $i <= 3; $i++) {
            ...
            $childAgeRange = $agi->get_data('ngo_ivr/mm/mm_intro_1', 23000, 1);

            if ($childAgeRange['result'] == 1) {

                // key message if pressed 1
                $agi->stream_file('ngo_ivr/mm/mm_key_message_pressed_1', 168000);
                ...
                for ($i = 1; $i <= 3; $i++) {
                    ...
                    if ($quizPress1Result['result'] == 1) {
                        ...
                        $agi->stream_file('ngo_ivr/mm/mm_quiz_press_1_correct', 12000);
                        $q1_answer = 1;
                        ...
                        $agi->stream_file('ngo_ivr/mm/mm_quiz_press_1_incorrect', 14000);
                        $q1_answer = 2;
        ...
        // outro
        $agi->stream_file('ngo_ivr/mm/mm_outtro', 15000);
        ...
        for ($i = 1; $i <= 3; $i++) {
            ...
            // mm intro and ask child age,  child age range (1 for 0-3, 2 for > 3)
            $childAgeRange = $agi->get_data('ngo_ivr/pok/poe_intro', 34000, 1);

            if ($childAgeRange['result'] == 1) {

                // key message if pressed 1
                $agi->stream_file('ngo_ivr/pok/poe_key_message_pressed_1', 281000);

                for ($i = 1; $i <= 3; $i++) {

                    // quiz if press 1
                    $quizPress1Result = $agi->get_data('ngo_ivr/pok/poe_quiz_press_1_result', 52000, 1);

                    if ($quizPress1Result['result'] == 1) {
                        // correct anaswer for press 1
                        $agi->stream_file('ngo_ivr/pok/poe_quiz_press_1_correct', 21000);
                        $q1_answer = 1;
                        ...
                        // incorrect answer for press 1
                        $agi->stream_file('ngo_ivr/pok/poe_quiz_press_1_incorrect', 23000);
                        $q1_answer = 2;
        ...
        // outro
        $agi->stream_file('ngo_ivr/pok/poe_outtro', 25000);
        // break loop
        break;
    } elseif ($chosenLang == 3) {
        for ($i = 1; $i <= 3; $i++) {
            ...
            // mm intro and ask child age,  child age range (1 for 0-3, 2 for > 3)
            $childAgeRange = $agi->get_data('ngo_ivr/skk/sk_intro', 27000, 1);

            if ($childAgeRange['result'] == 1) {

                // key message if pressed 1
                $agi->stream_file('ngo_ivr/skk/sk_key_message_pressed_1', 296000);

                for ($i = 1; $i <= 3; $i++) {

                    // quiz if press 1
                    $quizPress1Result = $agi->get_data('ngo_ivr/skk/sk_quiz_press_1_result', 35000, 1);

                    if ($quizPress1Result['result'] == 1) {
                        // correct anaswer for press 1
                        $agi->stream_file('ngo_ivr/skk/sk_quiz_press_1_correct', 20000);
                        $q1_answer = 1;
                        ...
                        // incorrect answer for press 1
                        $agi->stream_file('ngo_ivr/skk/sk_quiz_press_1_incorrect', 34000);
                        $q1_answer = 2;
        ...
        // outro
        $agi->stream_file('ngo_ivr/skk/sk_outtro', 31000);
