...
for ($i = 1; $i <= 3; $i++) {
    ...
    if ($chosenLang === "") {
        ...
        for ($i = 1; $i <= 3; $i++) {
            ...
            $childAgeRange = $agi->get_data('ngo_ivr/mm/mm_intro', 4862, 1);

            $agi->stream_file('ngo_ivr/mm/mm_key_message', 85789);

            for ($i = 1; $i <= 3; $i++) {

                // quiz if press 1
                $quizPress1Result = $agi->get_data('ngo_ivr/mm/mm_quiz', 19548, 1);

                if ($quizPress1Result['result'] == 1) {
                    // correct anaswer for press 2
                    $agi->stream_file('ngo_ivr/mm/mm_correct_answer', 9001);
                    $q1_answer = 2;
                    $conn->close();
                    break;
                } elseif ($quizPress1Result['result'] == 2) {
                    // incorrect answer for press 1
                    $agi->stream_file('ngo_ivr/mm/mm_incorrect_answer', 9465);
                    $q1_answer = 1;
                    break;
                } else {
                    // play invalid input
        ...
        for ($i = 1; $i <= 3; $i++) {
            ...
            // mm intro and ask child age,  child age range (1 for 0-3, 2 for > 3)
            $childAgeRange = $agi->get_data('ngo_ivr/pok/poe_intro', 6821, 1);



            // key message if pressed 1
            $agi->stream_file('ngo_ivr/pok/poe_key_message', 108991);
            ...
            for ($i = 1; $i <= 3; $i++) {
                ...
                if ($quizPress1Result['result'] == 1) {
                    // correct anaswer for press 2
                    $agi->stream_file('ngo_ivr/pok/poe_correct_answer', 11559);
                    $q1_answer = 2;
                    ...
                    // incorrect answer for press 1
                    $agi->stream_file('ngo_ivr/pok/poe_incorrect_answer', 15297);
                    $q1_answer = 1;
        ...
        // outro
        $agi->stream_file('ngo_ivr/pok/poe_outtro', 24339);
        // break loop
        break;
    } elseif ($chosenLang == 3) {
        for ($i = 1; $i <= 3; $i++) {
            ...
            // mm intro and ask child age,  child age range (1 for 0-3, 2 for > 3)
            $childAgeRange = $agi->get_data('ngo_ivr/skk/sg_intro', 8832, 1);



            // key message if pressed 1
            $agi->stream_file('ngo_ivr/skk/sg_key_message', 115174);

            for ($i = 1; $i <= 3; $i++) {

                // quiz if press 1
                $quizPress1Result = $agi->get_data('ngo_ivr/skk/sg_quiz', 34701, 1);

                if ($quizPress1Result['result'] == 1) {
                    // correct anaswer for press 2
                    $agi->stream_file('ngo_ivr/skk/sg_correct_answer', 14409);
                    $q1_answer = 2;
                    ...
                    // incorrect answer for press 1
                    $agi->stream_file('ngo_ivr/skk/sg_incorrect_answer', 18667);
                    $q1_answer = 1;
